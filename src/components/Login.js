...
const Login = () => {
  ...
  return (
    <div>
      ...
      <img className='absolute h-screen object-cover' src={BgImage} />
      </div>
      <form action="" className={`absolute w-full md:w-2/6 my-40 mx-auto bg-opacity-80  right-0 left-0 p-12 bg-black text-white rounded-lg`}>
        <center>
